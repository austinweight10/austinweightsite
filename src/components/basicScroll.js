    ...
    })(
      {
        ...
        4: [
          function(t, n, e) {
            ...
            var o = t('./bounce-out')
            n.exports = function(t) {
              return t < 0.5 ? 0.5 * (1 - o(1 - 2 * t)) : 0.5 * o(2 * t - 1) + 0.5
            }
          },
          { './bounce-out': 6 },
        ],
            ...
            var c,
              ...
              h = function(t, n) {
                ...
                return (
                  ...
                  'bottom' === i && (c -= o),
                  'top' === u && (c += r.top + e),
                  'middle' === u && (c += r.top + e + r.height / 2),
                  'bottom' === u && (c += r.top + e + r.height),
                  c + 'px'
                )
              },
              b = function(t) {
                      ...
                      n = (function() {
                        var o =
                          0 < arguments.length && void 0 !== arguments[0]
                            ...
                            : {}
                        if (
                          (null == (o = Object.assign({}, o)).inside &&
                            (o.inside = function() {}),
                          null == o.outside && (o.outside = function() {}),
                          null == o.direct && (o.direct = !1),
                          null == o.track && (o.track = !0),
                          null == o.props && (o.props = {}),
                          null == o.from)
                        )
                          throw new Error('Missing property `from`')
                        if (null == o.to) throw new Error('Missing property `to`')
                        if ('function' != typeof o.inside)
                          throw new Error(
                            'Property `inside` must be undefined or a function'
                          )
                        if ('function' != typeof o.outside)
                          throw new Error(
                            'Property `outside` must be undefined or a function'
                          )
                        if (
                          'boolean' != typeof o.direct &&
                          o.direct instanceof HTMLElement == 0
                        )
                          throw new Error(
                            'Property `direct` must be undefined, a boolean or a DOM element/node'
                          )
                        if (!0 === o.direct && null == o.elem)
                          throw new Error(
                            'Property `elem` is required when `direct` is true'
                          )
                        if ('boolean' != typeof o.track)
                          throw new Error(
                            'Property `track` must be undefined or a boolean'
                          )
                        if ('object' !== u(o.props))
                          throw new Error(
                            'Property `props` must be undefined or an object'
                          )
                        if (null == o.elem) {
                          if (!1 === l(o.from))
                            throw new Error(
                          ...
                          !0 === m(o.from) && (o.from = h(o.from, o.elem)),
                            !0 === m(o.to) && (o.to = h(o.to, o.elem))
                        return (
                          (o.from = d(o.from)),
                          (o.to = d(o.to)),
                          (o.props = Object.keys(o.props).reduce(function(t, n) {
                            ...
                            if (
                              ((e.from = d(e.from)),
                              (e.to = d(e.to)),
                              null == e.timing && (e.timing = i.default.linear),
                              'string' != typeof e.timing &&
                                'function' != typeof e.timing)
                            )
                              throw new Error(
